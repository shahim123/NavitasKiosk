...
<body>
    ...
    <?php
    include './partials/_nav2.php'; //Inclduing our navbar for staff
    ?>
    ...
    <table>
        ...
        <thead>
            ...
            //Selecting and fetching data from the search table of database
            $sql = "select * from search";
            $result = mysqli_query($conn, $sql);
            //Checking if rows are present and giving out the data    
