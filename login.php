        ...
        <div class="container">
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-5">
                    ...
                    <h4>Sign in as STUDENT:</h4>
                    <!--Form Creation for our login page-->
                    <form action="/kiosk/login.php" method="post">
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="text" placeholder="Student ID" class="form-control my-3 p-4" id="username" name="username" aria-describedby="emailHelp">
                            </div>
                        </div>
                        <div class="form-row">
