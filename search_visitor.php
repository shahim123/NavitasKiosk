...
<body>
    ...
    <?php
    include './partials/_nav1.php'; //Inclduing our nav1 navbar
    ?>
    <!--Making our search box -->
    ...
    <table>
        ...
        <thead>
            ...
            //Selecting all from our search table in db
            $sql = "select * from search";
            $result = mysqli_query($conn, $sql);
            //Checking if any rows are there, fetching data if present    
